...
#
# auto_pa_train_after_fe.py : Train a classifier to automatically
# measure PA, using manually annotated PAs for which features have
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Train a classifier to automatically measure PA, using manually '
                                                 'annotated PAs for which features have already been extracted using '
                                                 'auto_pa_extract_features.py, resulting in a set of feature files and labels.')
