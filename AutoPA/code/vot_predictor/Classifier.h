...
class Classifier
  ...
  public:
    ...
    void save_avg_w(std::string &filename);
    ...
    double update_direct_loss(SpeechUtterance& x, VotLocation &y_hat_eps, 
                              ...
                              double epsilon);
    double predict(SpeechUtterance& x, VotLocation &y_hat, bool pos_only=false, bool use_avg_w=false);
    ...
    infra::vector get_current_w_avg(void);
